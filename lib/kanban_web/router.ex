defmodule KanbanWeb.Router do
  ...
  scope "/", KanbanWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{KanbanWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", KanbanWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{KanbanWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", KanbanWeb do
    ...
    live_session :current_user,
      on_mount: [{KanbanWeb.UserAuth, :mount_current_user}] do
